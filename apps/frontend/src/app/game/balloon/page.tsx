...
import BalloonGameControls, {
  BalloonGameParams,
} from "@/components/games/balloon/BalloonGameControls";
...
export default function BalloonPage() {
  ...
  const [gameParams, setGameParams] = useState<BalloonGameParams>({
    difficulty: "medium",
    pumpMode: "custom",
              ...
              {result && (
                ...
                >
                  ...
                  <div className="text-xl">
                    Pumps: {result.pumps} / Burst at: {result.burstAt}
                  </div>
