...
export default function JackpotHistoryPage() {
  ...
  const biggestWin =
    winners.length > 0 ? Math.max(...winners.map((w) => w.amount)) : 0;
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-3 gap-6 mb-12">
          ...
          <div className="card text-center">
            ...
            <div className="text-3xl font-bold text-special">
              {winners.length}
            </div>
          </div>
        </div>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      <div className="font-bold text-lg">
                        {w.userId?.username || "Anonymous"}
                      </div>
                      <div className="text-sm text-gray-400">
                        {w.jackpot?.gameType || "Unknown"} • {w.currency}
                      </div>
                    </div>
                  </div>
