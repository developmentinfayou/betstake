    ...
    <div>
      ...
      <div className="flex items-center justify-between w-full px-4 py-2 bg-[#0a0b14] border-b border-gray-800 text-gray-400">
        <div className="flex items-center space-x-4">
          ...
          <button className="flex items-center px-4 py-1.5 bg-[#a2ffda] text-[#0a0b14] font-bold rounded-md hover:bg-[#85eec5] transition shadow-lg shadow-emerald-500/10">
      ...
      <div className="w-full max-w-md p-4 rounded-xl bg-[#0d121d]/95 border border-gray-800 shadow-2xl backdrop-blur-md text-gray-400 font-sans">
