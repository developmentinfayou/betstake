...
const Challenge = () => {
  return (
    <div className='mt-2'>
      <div className="w-full max-w-5xl p-6 text-gray-300 font-sans">
  ...
  <div className="flex items-center justify-between mb-6">
    <div className="flex items-center space-x-4">
      ...
      <span className="text-sm font-semibold text-gray-500">Challenges</span>
      <span className="text-sm font-semibold text-orange-500 border-b border-orange-500 cursor-pointer">View All</span>
    </div>
  </div>
  ...
  <div className="flex flex-col md:flex-row gap-6 items-start">
    ...
    <div className="flex-grow">
      ...
      <p className="text-sm leading-relaxed text-gray-400 mb-6 max-w-3xl">
        ...
        <span className="text-orange-500 cursor-pointer border-b border-orange-500/30 hover:border-orange-500">see more</span>
      </p>
      ...
      <div className="flex items-center space-x-6">
        ...
        <div className="flex items-center space-x-2">
          <span className="text-orange-500">🎁</span>
          <span className="text-sm font-mono text-gray-200">0.01000000 BTC</span>
        </div>
      </div>
    </div>
  </div>
