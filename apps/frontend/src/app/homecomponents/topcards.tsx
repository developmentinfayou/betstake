...
const TopCards = () => {
  ...
  `}
      ...
      <div className="flex flex-col gap-1.5">
        <div
          className={`relative w-[335px]  rounded border border-[#2A2A3C] p-3  ${
            boosts
            ...
            <div className="flex items-center justify-between w-full">
              ...
              >
                ...
                <button
                  ...
                  className={`inline-flex group items-center gap-[7px] px-3 py-1.5 rounded transition-all duration-300 ${
                    activeEdge === "premium"
    ...
    activeEdge === "premium"
      ...
      : "opacity-0 group-hover:opacity-100"
                ...
                <button
                  ...
                  className={`inline-flex group items-center w-[62.07px] h-[29px] gap-[7px] px-3 py-1.5 rounded transition-all duration-300 ${
                    activeEdge === "vip"
                      ? "bg-white/[0.06] text-white scale-100"
                      : "bg-transparent text-[#818181]"
                  }`}
              ...
              <div className="flex w-full items-center justify-between gap-4">
                ...
                <div className="flex-1 w-[138px] h-[4px] bg-white/10 rounded overflow-hidden">
                  <div
                    ...
                    style={{ width: "65%", background: "linear-gradient(90deg, #6FE970 0%, #13AEF0 100%)"
                    }} // 👈 change dynamically
